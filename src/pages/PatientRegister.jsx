  ...
  const handleStep2 = async (e) => {
    ...
    try {
      await patientService.updateProfile(
        ...
        localStorage.getItem("sync_auth")
      );
      navigate("/patient/dashboard");
    } catch (err) {
      setError(err.message + " You can retry or continue later.");
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="min-h-screen flex flex-col items-center justify-center px-4 pt-24 pb-16">
        <div ref={formRef} className="w-full max-w-md">
              ...
              <div key={label} className="flex items-center gap-3">
                <div className="flex items-center gap-2">
                  <div
                    ...
                    style={{
                      background: step > i ? "#2E4036" : step === i + 1 ? "#2E4036" : "rgba(46,64,54,0.1)",
                      color: step >= i + 1 ? "#F2F0E9" : "rgba(46,64,54,0.4)",
                  ...
                  <span
                    className="text-xs"
                    style={{
                      color: step === i + 1 ? "#2E4036" : "rgba(26,26,26,0.4)",
                      fontFamily: "'Outfit', sans-serif",
                ...
                {i < STEPS.length - 1 && (
                  <div className="w-8 h-px" style={{ background: "rgba(46,64,54,0.15)" }} />
                )}
              </div>
            ))}
          </div>
          ...
          >
            ...
            {step === 1 && (
              <form onSubmit={handleStep1} className="flex flex-col gap-5">
                <div>
                  <label className="block text-xs uppercase tracking-wider mb-2" style={{ color: "#2E4036", fontFamily: "'IBM Plex Mono', monospace" }}>
                    Full name
                  </label>
                  <input
                    type="text"
            ...
            {step === 2 && (
              <form onSubmit={handleStep2} className="flex flex-col gap-5">
                <p className="text-sm mb-1" style={{ color: "#1A1A1A", opacity: 0.6, fontFamily: "'Outfit', sans-serif" }}>
                ...
                >
                  <p className="text-xs uppercase tracking-wider mb-3" style={{ color: "#2E4036", fontFamily: "'IBM Plex Mono', monospace" }}>
                    Emergency contact
                  </p>
          ...
          <p className="text-center mt-5 text-sm" style={{ color: "#1A1A1A", opacity: 0.5, fontFamily: "'Outfit', sans-serif" }}>
            ...
            <Link to="/login" className="font-semibold underline underline-offset-2" style={{ color: "#2E4036" }}>
              Sign in
            </Link>
          </p>
        </div>
